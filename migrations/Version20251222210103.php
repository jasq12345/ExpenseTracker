 ...
 */
final class Version20251222210103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction DROP FOREIGN KEY `FK_723705D19777D11E`');
        $this->addSql('ALTER TABLE transaction DROP FOREIGN KEY `FK_723705D19D86650F`');
        $this->addSql('DROP INDEX IDX_723705D19777D11E ON transaction');
        $this->addSql('DROP INDEX IDX_723705D19D86650F ON transaction');
        $this->addSql('ALTER TABLE transaction CHANGE category_id_id category_id INT DEFAULT NULL, CHANGE user_id_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT `FK_64C19C19D86650F` FOREIGN KEY (user_id_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE transaction CHANGE category_id category_id_id INT DEFAULT NULL, CHANGE user_id user_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE transaction ADD CONSTRAINT `FK_723705D19777D11E` FOREIGN KEY (category_id_id) REFERENCES category (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE transaction ADD CONSTRAINT `FK_723705D19D86650F` FOREIGN KEY (user_id_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_723705D19777D11E ON transaction (category_id_id)');
