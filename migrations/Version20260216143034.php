 ...
 */
final class Version20260216143034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE budget (id INT AUTO_INCREMENT NOT NULL, limit_amount NUMERIC(10, 2) NOT NULL, current_amount NUMERIC(10, 2) NOT NULL, month SMALLINT NOT NULL, year SMALLINT NOT NULL, spent_amount NUMERIC(10, 2) NOT NULL, budget_policy_policy VARCHAR(255) NOT NULL, budget_policy_warning_threshold SMALLINT DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_73F2F77BA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, price NUMERIC(10, 2) NOT NULL, amount INT NOT NULL, created_at DATETIME NOT NULL, description VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, category_id INT DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_723705D112469DE2 (category_id), INDEX IDX_723705D1A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
